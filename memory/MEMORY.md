...
- [Fixture ground-truth contract](fixture-ground-truth-contract.md) — authored expected values live in electroswag `contract.ts`; parser mirror at `tests/fixtures/electroswag-v13.json`
