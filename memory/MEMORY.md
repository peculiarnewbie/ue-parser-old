...
- [UserDefinedStruct fixture spec](userdefinedstruct-fixture-spec.md) — v17 UDS decoder blocked on authoring a ground-truth fixture; field spec + already-researched FField wire format
