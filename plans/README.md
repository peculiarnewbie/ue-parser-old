...
| 004 | Counter / Stats.EventBatch2 / CSV samples | P1 | M | targeted fixture with samples | TODO (deferred) |
| 005 | TaskTrace waits + thread-group membership | P1 | L | 002 helpful for correlating waits to frames | TODO (deferred) |
